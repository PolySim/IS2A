...
public interface IServiceEcolesPolytech  {
	...
	void modifierSiteWeb(String nomEcole, String url) throws EcoleInconnueException;
	Collection<Specialite> getSpecialites(String nomEcole) throws EcoleInconnueException;
}
