...
- Lors de l'installation, `poetry` vous rappelle : "Add `export PATH="~/.local/bin:$PATH"` to your shell configuration file." Ajoutez la ligne correspondante dans votre `.bashrc`
